...
class _RunLog:
    """One temp log containing useful run metadata and raw script bytes."""
    ...
    def raw_output_stream(self) -> BinaryIO:
        """Return the binary destination used by process output capture."""
...
@contextmanager
def temporary_run_log() -> Iterator[_RunLog]:
